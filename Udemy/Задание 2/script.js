...
1, т.к. мы обратились к первому элементу строки
...
А должно быть наоборот. Чтобы получить верное значение, запишем так:
let collator = new Intl.Collator();
alert( collator.compare("ёжик", "яблоко") ); // -1 (ёжик меньше)

Чему равно 0 || "" || 2 || undefined || true || falsе ?
2, т.к. || возвращает первое значение, которое дает true
